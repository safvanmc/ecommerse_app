...
class Womentop extends StatefulWidget {
  ...
  @override
  State<Womentop> createState() => _WomentopState();
}

class _WomentopState extends State<Womentop> {
  int selectedIndex = 0;
  bool toggle = false;
  bool saf=false;
  bool saf1=false;
        ...
        body: Column(crossAxisAlignment: CrossAxisAlignment.start,
          ...
          Padding(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text('Women\'s tops',style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontSize: 40,),),
              ...
              Expanded(flex:1,child: Stack(
                children: [
                  Container(color: Color.fromARGB(255, 238, 235, 235),width: double.infinity,child: Padding(
                      ...
                      child: Column(mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                        children: [
                          ...
                          child: Row(
                            children: [
                              InkWell(onTap: () {
                                Navigator.push(context, MaterialPageRoute(builder: (context) => Shortop(),));
                              },
                                child: Container(decoration:BoxDecoration(borderRadius: BorderRadius.only(topLeft: Radius.circular(10),bottomLeft: Radius.circular(10)),color: Color.fromARGB(
                  ...
                  Positioned(right: 20,top: 90,child: CircleAvatar(radius: 20,backgroundColor: Colors.white,child: IconButton(icon: toggle ? Icon(Icons.favorite_border,color: Colors.grey,)
                      : Icon(
                  ...
                  Positioned(right: 20,top: 210,child: CircleAvatar(radius: 20,backgroundColor: Colors.white,child: IconButton(icon: saf ? Icon(Icons.favorite_border,color: Colors.grey,)
                      : Icon(
                    Icons.favorite,color: Colors.red,
                  ),onPressed: () {
                    setState(() {
                  ...
                  Positioned(right: 20,top: 330,child: CircleAvatar(radius: 20,backgroundColor: Colors.white,child: IconButton(icon: saf1 ? Icon(Icons.favorite_border,color: Colors.grey,)
                      : Icon(
                    Icons.favorite,color: Colors.red,
                  ),onPressed: () {
                    setState(() {
                  ...
                  Positioned(right: 20,top: 450,child: CircleAvatar(radius: 20,backgroundColor: Colors.white,child: IconButton(icon: saf2 ? Icon(Icons.favorite_border,color: Colors.grey,)
                      : Icon(
                    Icons.favorite,color: Colors.red,
                  ),onPressed: () {
                    setState(() {
